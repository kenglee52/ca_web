// src/pages/verifier/ceoInbox.jsx
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="border-none shadow-lg">
        <CardHeader>
          <CardTitle className="text-lg">ຄຳຂໍກູ້ທີ່ລໍຖ້າການກວດສອບ (PENDING_ceo)</CardTitle>
        </CardHeader>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ບໍ່ພົບຄຳຂໍກູ້ທີ່ລໍຖ້າການກວດສອບໃນສະຖານະ PENDING_ceo
            </div>
          ) : (
            <>
