        ...
        <div className="p-6 space-y-6">
            ...
            {loading ? (
                ...
                <>
                    ...
                    <Card className="border-none shadow-lg">
                        <CardHeader>
                            <CardTitle className="text-lg">ການດຳເນີນການ (CEO)</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <CEOActions
                                appId={appId}
                                ...
                                disabled={
                                    loading ||
                                    !app?.assessment ||
                                    app?.assessment?.currentApprovalStep !== "APPROVED"
                                }
                                endpoints={{
                                    approve: "/loan-applications/:id/approve-by-ceo",
                                    reject: "/loan-applications/:id/reject-by-ceo",
                            ...
                            {app?.assessment?.currentApprovalStep !== "PENDING_CEO" && (
                                <div className="text-xs text-muted-foreground mt-3">
                                    * ບໍ່ສາມາດກົດໄດ້ ເນື່ອງຈາກບໍ່ຢູ່ໃນຂັ້ນຕອນ PENDING_CEO
                                </div>
                            )}
                        </CardContent>
                    </Card>
...
export default CEOApplicationDetail;
