// src/pages/officer/VerifierAllCases.jsx
...
const VerifierAllCases = () => {
  ...
  const fetchVerifierAllCases = async () => {
    setLoading(true);
    try {
      const params = {
        q: q.trim() || undefined,
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button className="bg-orange-600 hover:bg-orange-700 gap-2" onClick={fetchVerifierAllCases}>
        ...
        <Card className="mb-8 shadow-md border-none">
          <CardContent className="p-6">
            ...
            <div className="flex justify-end mt-6 gap-3">
              ...
              <Button className="bg-orange-600 hover:bg-orange-700" onClick={fetchVerifierAllCases}>
                ຄົ້ນຫາ
              </Button>
            </div>
          </CardContent>
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                onClick={() => navigate(`/verifier/cases/${item.id}`)}
                              >
...
export default VerifierAllCases;
