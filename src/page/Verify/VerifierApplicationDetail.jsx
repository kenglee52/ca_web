...
import VerifierActions from "@/component/verify/VerifierActions";
...
const VerifierApplicationDetail = () => {
                        ...
                        <CardContent>
                            <VerifierActions
                                ...
                                disabled={
                                    loading ||
                                    !app?.assessment ||
                                    app?.assessment?.currentApprovalStep !== "PENDING_VERIFIER"
                                }
                                endpoints={{
                                    approve: "/loan-applications/:id/approve-by-verifier",
                                    reject: "/loan-applications/:id/reject-by-verifier",
                                    return: "/loan-applications/:id/return-by-verifier",
                                }}
                            />

                            {app?.assessment?.currentApprovalStep !== "PENDING_VERIFIER" && (
                                <div className="text-xs text-muted-foreground mt-3">
                                    * ບໍ່ສາມາດກົດໄດ້ ເນື່ອງຈາກບໍ່ຢູ່ໃນຂັ້ນຕອນ PENDING_VERIFIER
                                </div>
                            )}
                        </CardContent>
                    </Card>
