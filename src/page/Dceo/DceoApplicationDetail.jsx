...
import DceoActions from "@/component/dceo/DceoActions";
    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <div className="text-2xl font-bold text-orange-700">ລາຍລະອຽດຄຳຂໍກູ້</div>
            ...
            {loading ? (
                ...
                <>
                    ...
                    <Card className="border-none shadow-lg">
                        <CardHeader>
                            <CardTitle className="text-lg">ການດຳເນີນການ (Verifier)</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <DceoActions
                                appId={appId}
                                ...
                                disabled={
                                    loading ||
                                    !app?.assessment ||
                                    app?.assessment?.currentApprovalStep !== "PENDING_CEO"
                                }
                                endpoints={{
                                    approve: "/loan-applications/:id/approve-by-dco",
                                    reject: "/loan-applications/:id/reject-by-dco",
                               
                                }}
                            />

                            {app?.assessment?.currentApprovalStep !== "PENDING_DCO" && (
                                <div className="text-xs text-muted-foreground mt-3">
                                    * ບໍ່ສາມາດກົດໄດ້ ເນື່ອງຈາກບໍ່ຢູ່ໃນຂັ້ນຕອນ PENDING_DCO
                                </div>
                            )}
                        </CardContent>
                    </Card>
...
export default DceoApplicationDetail;
