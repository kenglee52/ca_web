// src/pages/officer/DcoeAllCasws.jsx
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button className="bg-orange-600 hover:bg-orange-700 gap-2" onClick={fetchDcoeAllCasws}>
        ...
        <Card className="mb-8 shadow-md border-none">
          <CardContent className="p-6">
            ...
            <div className="flex justify-end mt-6 gap-3">
              ...
              <Button className="bg-orange-600 hover:bg-orange-700" onClick={fetchDcoeAllCasws}>
                ຄົ້ນຫາ
              </Button>
            </div>
          </CardContent>
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                onClick={() => navigate(`/dceo/all-cases/${item.id}`)}
                              >
