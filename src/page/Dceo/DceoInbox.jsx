// src/pages/verifier/DceoInbox.jsx
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ບໍ່ພົບຄຳຂໍກູ້ທີ່ລໍຖ້າການກວດສອບໃນສະຖານະ PENDING_DCEO
            </div>
          ) : (
            <>
