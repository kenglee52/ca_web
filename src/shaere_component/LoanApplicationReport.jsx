// src/pages/officer/LoanApplicationReport.jsx
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-2xl font-bold text-orange-700">ລາຍລະອຽດ Report ຄຳຂໍກູ້</div>
              ...
              {!app.assessment ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <KV label="ສະຖານະການອະນຸມັດ" value={app.assessment.finalApprovalStatus || "-"} />
                  </div>
          ...
          <Card className="border-none shadow-lg">
            ...
            <CardContent>
              <div className="bg-gray-50 p-4 rounded-md border">
                {app.assessment?.preparerComments || "ຍັງບໍ່ມີຄຳເຫັນ"}
              </div>
            </CardContent>
          </Card>
           <Card className="border-none shadow-lg">
